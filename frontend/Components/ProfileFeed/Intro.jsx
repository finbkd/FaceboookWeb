  ...
  return (
    <div className={styles.introContainer}>
      ...
      <div className={styles.about}>
        ...
        <span>Studied at</span> <div>{userData?.studiedAt}</div>
      </div>
      <div className={styles.about}>
