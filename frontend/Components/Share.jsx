    ...
    <div className={styles.container}>
      <div className={styles.sharebox}>
        <div className={styles.shareTop}>
          <img className={styles.shareProfile} src="/images/lorde.jpg" />
          <input className={styles.inputText} type="text" id="fname" name="fname" value="" placeholder="What's on your mind, Lorde?" />
        </div>
        <hr />
