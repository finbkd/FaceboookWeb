        ...
        <div className={styles.postContainer}>
          <div className={styles.postHeader}>
            ...
            <div className={styles.userInfo}>
              <div className={styles.userName}>Vikas</div>
              <div className={styles.postDate}>5th june</div>
            </div>
          </div>
          <div className={styles.postContent}>
            <p className={styles.postDesc}>This is so cool!!</p>
            <img className={styles.postImg} src="/images/lorde-5.jpg"></img>
          </div>
          <div className={styles.postResponseTop}>
            <div className={styles.postLeftTop}>
              ...
              <div className={styles.likeNames}>Taylor and 22 others</div>
            </div>
            <div className={styles.postRighTop}>25 Comments</div>
          </div>
          <hr />
